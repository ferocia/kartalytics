...
require_relative '../fragment/score_block'
      ...
      def scores
        @scores ||= begin
          score_positions.map do |x, y|
            score_image = sub_image(x, y, Fragment::ScoreBlock::WIDTH, Fragment::ScoreBlock::HEIGHT)
            Fragment::ScoreBlock.new(score_image).to_i
          end
        end
      end
